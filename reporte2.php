...
$query = "SELECT * FROM usuario INNER JOIN locker WHERE locker.id_locker = usuario.id_locker AND estado = 'Ocupado'";
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        if ($this->isFirstPage) { // Mostrar el título solo en la primera página
            ...
            $this->Cell(0, 10, 'REPORTE DE LOS USUARIOS ACTIVOS', 0, 1, 'C');
            $this->Ln(10);
...
$pdf->Cell(0, 10, 'La siguiente tabla muestra los alumnos activos: ', 0, 1); 
